...
<style scoped>
  ...
  .menu{width: 180px !important;height: 100%;position: fixed;top: 0;left: 0;bottom: 0;z-index: 1001;background: #304156;overflow-x: hidden !important;}
  .right{position:relative;margin-left: 180px;min-height: 100%;background: #fff;}
